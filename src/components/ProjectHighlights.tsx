...
const ProjectHighlights: React.FC<ProjectHighlightsProps> = ({ onBrochureClick }) => {
    const handleViewNumber = () => {
        window.location.href = 'tel:+919090907712';
    };
                ...
                <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 lg:gap-20 items-center">
                    ...
                    <div>
                        ...
                        <div className="flex flex-col md:flex-row gap-4">
                            ...
                            <button onClick={onBrochureClick} className="flex-1 border border-[#005bb7] text-[#005bb7] hover:bg-blue-50 py-3 px-6 rounded-md font-bold text-sm uppercase tracking-wide transition-colors flex items-center justify-center gap-2">
